...
export const FoodItemsDelivery = ({navigation}: any) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonRow}>
        <TouchableOpacity style={styles.approveBtn} onPress={() => navigation.navigate(RiderDashboard)}>
          <Text style={styles.approveText}>Pick and Deliver</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.outStockBtn}>
          <Text style={styles.outStockText}>Busy</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
